...
BR="\033[0;34m"
U="\033[0;35m"
#di sarankan untuk yg sudah pengalaman sqli manual hacking
   ...
   3) clear
      ...
      case $d in
       1) 
          ...
          read -p "quay lại menu y / n? " tanya
      if [[ "$tanya" = "y" ]];then
         menu
      fi
        ;;
...
${G}██╗░░██╗░░░░░░  ██████╗░███████╗██╗░░░██ ${N}
${G}╚██╗██╔╝░░░░░░  ██╔══██╗██╔════╝██║░░░██║ ${N}
${G}░╚███╔╝░█████╗  ██║░░██║█████╗░░╚██╗░██╔╝${N}   \033[7;36m PSQL-I v.1 MOD ${N}\033[1;36m\033[1m FINAL${N}
${G}░██╔██╗░╚════╝  ██║░░██║██╔══╝░░░╚████╔╝░ ${N}    \033[2m |==┣▇▇▇▇▇▇▇▇═─-SQl-i ${N}
${G}██╔╝╚██╗░░░░░░  ██████╔╝███████╗░░╚██╔╝░░${N}       ${R}Hoangdev${N}Sqli tool${N}
${G}╚═╝░░╚═╝░░░░░░  ╚═════╝░╚══════╝░░░╚═╝░░░${N}      ${O}Zalo Liên Hệ :0915722710${O}3${O}n${N} 
     ${G}V1 New Tool By Hoang.X.Developer${N}
       ${G}    Chào anh em
        ${R} Database Hacker Web ${N}"
}
banner1(){
	echo -e "
          ...
          ____________________________________________
            ...
            \033[7;31m Hacker${N}${R} Sql\033[0m
 ⠀⠀⠀⠀⠀⠀⠀⣀⣤⣶⣶⣿⣿⣿⣶⣶⣤⣄⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣠⣴⣶⣿⣿⣿⣿⣿⣷⣶⣦⣄⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⣰⣾⣿⣿⣿⣿⣿⣿⣿⣯⣭⣙⡛⠻⠷⣦⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣀⣴⠾⠟⢛⣋⣭⣽⣿⣿⣿⣿⣿⣿⣿⣿⣷⣄⠀⠀⠀⠀
⠀⠀⠀⢀⣾⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣷⣦⣀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣠⣴⣾⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣦⠀⠀⠀
⠀⠀⢀⡾⠿⠟⠛⠛⠛⠛⠛⠛⠿⢿⣿⣿⣿⣿⣿⣿⣿⣷⣦⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣴⣿⣿⣿⣿⣿⣿⣿⣿⡿⠿⠛⠛⠛⠛⠛⠛⠛⠿⠿⣷⡀⠀
...
banner2() {
echo -e "                    \033[7;31m PSQL-I Chích web đê ${N}${R} Bản V1${N}${G}"
cat << "EOF"
─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
───────────────────────────────────────────────────────────────
─██████──██████─██████████████─██████████████─██████──████████─
...
─────██─▀███▀─██──────                ${N}|==┣▇▇▇▇▇▇═─-SQl-i${N}
───▄─▀████▀████▀─▄────                ${N}|Zalo:https://zalo.me/g/kwhvyt167${N}
───▄─▀████▀████▀─▄────
─▀█────██▀█▀██────█▀──                ${R}Hacker${N} Sql${N}
   copyright © 2022                   ${O}Wellcome Hacker Haha${O}${O}${N}
        "
}
msg2() {
  echo -e "${O}        +──────────────────────────────────────────────+
...
gen() {
  echo -e "                |\033[7;32m Dork generator by hoangdev ${N}|\n\n${O}cth: product cart buy${N}"
